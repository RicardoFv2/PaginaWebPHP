...
<body>
    ...
    <div class="container">
        ...
        <div class="products">
            ...
            if (mysqli_num_rows($select_user) > 0) {
                while ($fetch_product = mysqli_fetch_assoc($select_user)) {
                    ...
                    <form method="post" class="box" action="">
                        ...
                        <div>
                            ...
                            <input type="name" min="1" name="product_quantity" value="1">
                            <input type="hidden" name="product_images" value="<?php echo $fetch_product['images']; ?>">
                            <input type="hidden" name="product_name" values="<?php echo $fetch_product['name']; ?>">
